...
//목표 : D:/upload(또는 다른 경로) 에 있는 test.txt라는 파일을 접속 시 바로 다운로드하도록 페이지 구성
@WebServlet(urlPatterns = "/download.kh")
public class FileDownloadServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		File target = new File("D:/upload", "test.txt");
		...
		resp.setHeader("Content-Type", "application/octet-stream");//다운로드 받아야 하는 데이터임을 표시
