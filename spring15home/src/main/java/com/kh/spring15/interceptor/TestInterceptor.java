 ...
 * = DispatcherServle 설정파일인인 servlet-context.xml에 등록해야 한다.
*/ 
public class TestInterceptor implements HandlerInterceptor{
	 ...
	 * 	   - java reflection이라는 기술을 전제 조건으로 한다.
	 */
	@Override
	 ...
	 * -handler를 이용하여 실행한 기능르 확인할 수 있다.
	...
	/**
	 * atferCompletion은 View까지 완성된 이후의 상황을 간섭한다.
