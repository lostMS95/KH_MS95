...
public class Test01 {
	public static void main(String[] args) {
		...
		// ex : 1부터 10 사이의 정수를 추첨
		double a = Math.random(); // 0 이상 1 미만 double
		double b = a * 10; // 0 이상 10 미만 double
		...
		// = 만약 10부터 99까지라면 Java는 10부터 90개라고 표현한다.
		int number = (int) (Math.random() * 10) + 1;
		System.out.println("number = " + number);

		// Random을 이용해서 랜덤값을 뽑는 방법
		// int number = r.nextInt(개수) + 시작;
		Random r = new Random();
