...
public class Test01 {
	...
	public void test() {
		...
		sender.setUsername("testmszero");//이용자 계정명
		sender.setPassword("test1234!!@@");//이용자 비밀번호
		...
		message.setTo("testmszero@gmail.com");
		
		message.setCc("testmszero@gmail.com");
		
		message.setSubject("힘내자");
		
		message.setText("아자아자~");
