...
*	2.	@WebFilter 를 통한 등록 및 주소 설정
*	3. 메소드를 재정의를 통하여 수행할 내용을 작성(doFilter 메소드)
*/
...
public class TestFilter implements Filter{
	 ...
	 *  
	 *  (결론) Servlet에서 하던 작업을 Fiter에서 하고싶다면 request객체를 "다운캐스팅"해서 사용해야 한다.
	 */
