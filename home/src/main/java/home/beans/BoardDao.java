...
public class BoardDao {
	...
	//검색기능
	public List<BoardDto> select(String column,String keyword) throws Exception {
		Connection con = JdbcUtils.connect2();
	...
	//상세보기 기능
	public BoardDto select(int boardNo) throws Exception {
		Connection con = JdbcUtils.connect2();
	...
	//등록 기능2 : 번호를 미리 생성해놓은 경우의 추가 기능
		public void insert2(BoardDto boardDto) throws Exception {
			Connection con = JdbcUtils.connect2();
	...
	//페이징 목록
	public List<BoardDto> listByTopN(int begin, int end) throws Exception {
			Connection con = JdbcUtils.connect2();
	...
	//페이징 검색
	public List<BoardDto> searchByTopN(String column,String keyword,int begin,int end) throws Exception{
		Connection con = JdbcUtils.connect2();
	...
	//계층형 목록(tree)
		...
		ps.setString(3, boardDto.getBoardTitle());
		ps.setString(4, boardDto.getBoardContent());
		ps.setInt(5, boardDto.getBoardSuperno());
		ps.setInt(6, boardDto.getBoardGroupno());
		ps.setInt(7, boardDto.getBoardDepth());
		ps.execute();
