...
@WebServlet(urlPatterns = "/point/cancel.kh")
public class PointCancelServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		try {
			...
			if (cancelDao.available(historyNo)) {// 취소 가능하다면
				...
				// memberDao.removePoint(historyDto.getMemberId(),
				// historyDto.getHistoryAmount());
